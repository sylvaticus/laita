...
# dist-chrome/ is generated, not committed, and more than one test depends on it. Generating it
...
../tools/build-chrome.sh >/dev/null || { echo "generator failed: ../tools/build-chrome.sh"; exit 1; }
